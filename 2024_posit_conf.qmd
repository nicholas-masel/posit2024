...
-   Organizations that might think of this as old news. I've been there, done that, and have the t-shirt to prove it.
NEXT SLIDE.
:::
...
::: {.column width="33%" .fragment}
### General Contractor
![](presentation_files/Moa.png)
Modernization of Statistical Analytics
:::

::: {.column width="33%" .fragment}
### Sub-Contractors
![](presentation_files/RConsortium_Vertical_Pantone.png)
<br><br><br>
R Validation Hub
:::
...
-  Worry less about how results are formatted on a page, and more about results
NEXT SLIDE
